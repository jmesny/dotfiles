...
function git_prompt_info() {	
	...
	echo -e "${SCM_STATE}${SCM_PREFIX}${REF_COLOR}${SCM_BRANCH}:${DEFAULT_COLOR} ${SCM_CHANGE:0:$MAX_GIT_HEX_LENGTH}${SCM_SUFFIX} ${SCM_GIT_BEHIND:-0}↓${SCM_GIT_AHEAD:-0}↑${SCM_GIT_STASH}"
}
